...
const EMOJI_SUGGESTIONS: EmojiSuggestion[] = [
	...
	{kind: "emoji", label: "Highest priority / 最高优先级", insert: TASK_SYMBOLS.priority.highest},
	...
	{kind: "emoji", label: "Lowest priority / 最低优先级", insert: TASK_SYMBOLS.priority.lowest},
